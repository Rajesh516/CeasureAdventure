...
public class LevelManager : MonoBehaviour 
{
	...
	public void CoinUsed(int temp)
	{
		coins -= temp;										//Increase coin number
	}

	public void TorpedoExplodedSetter()
	{
		torpedoExploded++;
	}

	public int TorpedoExplodedGetter()
	{
		return torpedoExploded;
	}
	...
	{
		return crocodileExploded;
	}
	
	public int SkunkExplodedGetter()
	{
		return skunkExploded;
	}
	...
	public void Restart()
	{
        ...
        GUIManager.Instance.ShowStartPowerUps();					//Show the power up activation GUI					//Activate main GUI
        GUIManager.Instance.UpdateBestDistance();				//Update best distance at the hangar
	}
